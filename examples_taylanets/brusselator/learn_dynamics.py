...
if __name__ == "__main__":
    # python learn_dynamics.py --train_batch_size 500 --test_batch_size 1000 --lr_init 1e-3 --lr_end 1e-3 --test_freq 1000 --save_freq 20000 --n_steps 1 --pen_remainder 0 --nepochs 10000 --w_decay 1e-3 --grad_clip 0 --method tayla --order 1 --atol 1e-5 --rtol 1e-5 --mid_lr_init 1e-3 --mid_lr_end 1e-3 --mid_freq_update 30 --mid_num_grad_iter 1 --mid_grad_clip 0 --trajfile data/brusselator_dt0.1.pkl
    
    # Parse the command line argument
    parser = argparse.ArgumentParser('Learning Dynamics of Vanderpool System')
    ...
    parser.add_argument('--trajfile',  type=str, default='data/vanderpool_dt0.04.pkl')
