...
if __name__ == "__main__":
    # python learn_dynamics.py --train_batch_size 100 --test_batch_size 500 --lr_init 1e-3 --lr_end 1e-3 --test_freq 1000 --save_freq 20000 --n_steps 1 --pen_remainder 0 --nepochs 5000 --w_decay 0 --grad_clip 0 --method tayla --order 1 --atol 1e-5 --rtol 1e-5 --mid_lr_init 1e-4 --mid_lr_end 1e-5 --mid_freq_update 2000 --mid_num_grad_iter 1 --mid_grad_clip 0 --trajfile data/stifflinear_dt0.05.pkl
