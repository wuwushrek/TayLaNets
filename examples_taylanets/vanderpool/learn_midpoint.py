...
if __name__ == "__main__":
    # python learn_midpoint.py --train_batch_size 500 --test_batch_size 250 --lr_init 1e-4 --lr_end 1e-6 --test_freq 1000 --save_freq 10000 --n_steps 1 --nepochs 5000 --w_decay 0 --grad_clip 0 --method tayla --order 1 --atol 1e-5 --rtol 1e-5 --trajfile data/vanderpool_dt0.04.pkl

    # Parse the command line argument
    parser = argparse.ArgumentParser('Learning Midpoint of Vanderpool System')
